...
const DEFAULT_CHATBOT_FALLBACK_MESSAGE =
  "Oops I am not able to get context to answer your query!";
...
export default function SignUpPage() {
  ...
  function validatePassword(
    ...
    if (username) {
      ...
      if (
        usernameWithoutDomain.length >= 4 &&
        password.toLowerCase().includes(usernameWithoutDomain.toLowerCase())
      ) {
        return {
          isValid: false,
      ...
      if (emailParts.length > 1) {
        ...
        if (
          domain.length >= 4 &&
          password.toLowerCase().includes(domain.toLowerCase())
        ) {
          return {
            isValid: false,
            message: "Password should not contain parts of your email address",
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error: credentialsError } = await supabaseSignup
        .from("credentials")
        .insert([
          {
            username,
      ...
      const { error: themeError } = await supabaseSignup
        .from("chatbot_themes")
        .insert([
          {
            chatbot_id: chatbotId,
      ...
      if (typeof document !== "undefined") {
        ...
        document.documentElement.style.setProperty(
          "--border-radius",
          `${defaultThemeValues.borderRadius}px`,
        );
                ...
                <div className="w-full max-w-md space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Sign up to get started with Bot247
                    </p>
                  </div>
                            ...
                            <Tooltip>
                              ...
                              <TooltipContent side="right" className="max-w-xs">
                                ...
                                <ul className="list-disc pl-4 text-xs mt-1">
                                  ...
                                  <li>
                                    Not contain parts of your email address
                                  </li>
                                </ul>
                              </TooltipContent>
                            </Tooltip>
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            if (
                              ...
                              setPhoneNumber(
                                filteredValue.slice(0, selectedCountry.maxLen),
                              );
                            } else {
