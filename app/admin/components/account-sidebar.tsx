...
interface AccountSidebarProps {
  activePage: string
  chatbotId: string
  showLogout?: boolean // Add this prop
}

export default function AccountSidebar({ activePage, chatbotId, showLogout = true }: AccountSidebarProps) {
  ...
  const handleLogout = async () => {
    try {
      // Clear the entire localStorage instead of just adminData
      localStorage.clear()
