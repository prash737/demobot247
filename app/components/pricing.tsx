...
export function Pricing() {
  ...
  return (
    ...
    //   </div>
    // </section>
    <section className="pricing_section" id="pricing" style={{ marginBottom: "150px" }}>
      <div className="container" style={{ position: "relative", zIndex: "5" }}>
        <div className="row">
          <div className="col-lg-12 heading70 text-center mb-4" style={{ color: "#fff" }} data-aos="fade-right">
            Simple, Transparent Pricing
          </div>
        </div>
        <div className="row">
          <div className="col-lg-3"></div>
          <div className="col-lg-6 text-center mb-5" style={{ color: "#fff" }} data-aos="fade-left">
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="pricing_box" data-aos="flip-right">
              ...
              <div className="pricing_box_inner">
                ...
                <div className="row">
                  <div className="col-lg-12 price_list_box">
                    ...
                    <div className="price_list">Upto 20 data source(including URL, PDF, TXT, CSV)</div>
                    <div className="price_list">Priority support</div>
                    <div className="price_list">Advanced analytics & reporting</div>
            ...
            <div className="pricing_box" data-aos="flip-right">
              <div className="pricing_box_inner">
                ...
                <div className="row">
                  <div className="col-lg-12 price_list_box">
                    <div className="price_list">Whatsapp Business API Registration and Integration</div>
      ...
      <div className="purple_shape_btm1">
        <img src="/images/purple_shade.png" className="img-fluid" style={{ opacity: "0.5" }} alt="Purple shade background" ></img>
      </div>
    </section>
  )
}
