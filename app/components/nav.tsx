...
export function Nav() {
  ...
  useEffect(() => {
    ...
    // Check auth status only when needed - much less frequent to prevent memory issues
    const interval = setInterval(checkAuthStatus, 300000); // Every 5 minutes instead of 30 seconds
