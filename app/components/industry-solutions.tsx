  ...
  return (
    ...
    <section className="mb-5">
      <div className="container">
        <div className="row">
          <div className="col-lg-12 heading70 text-center" data-aos="fade-right">Solutions for Every Industry</div>
        </div>
        <div className="row">
          <div className="col-lg-3"></div>
          <div className="col-lg-6 text-center mb-5" data-aos="fade-left">
        ...
        <div className="row">
          <div className="col-lg-12">
            {industrySolutionsContent.map((solution, index) => {
              ...
              return (
                <Link href={`/solutions/${solution.id}`} key={index} className="block">
                  <div className="solution_list" data-aos="zoom-out">
                    <div className="solution_list_inner">
                      <div className="row" style={{ alignItems: "center" }}>
                        <div className="col-lg-3">
